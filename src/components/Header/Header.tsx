...
const Header = () => {
  const [languageAnchor, setLanguageAnchor] = useState<HTMLDivElement | null>(
    null
  );
  const [currencyAnchor, setCurrencyAnchor] = useState<HTMLDivElement | null>(
    null
  );
  ...
  const headerConfig = useSelector(
    (state: RootState) => state.config.headerConfig
  );
  ...
  const { logo, supportedLanguages, supportedCurrencies, title } = headerConfig;
